...
(def http-server (system/create-http config-file profile routes))
(def venn (system/init config-file profile http-server))

(def new-venn (system/init config-file profile))


(-> new-venn
    (system/with-http-component routes))
